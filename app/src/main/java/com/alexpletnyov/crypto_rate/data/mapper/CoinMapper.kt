...
class CoinMapper {
	...
	fun mapDbModelToEntity(dbModel: CoinInfoDbModel): CoinInfo = CoinInfo(
		...
		lastUpdateTime = convertTimestampToTime(dbModel.lastUpdate, TIME_PATTERN_ONLY_TIME),
		lastUpdateDataTime = convertTimestampToTime(dbModel.lastUpdate, TIME_PATTERN_DATA_AND_TIME),
